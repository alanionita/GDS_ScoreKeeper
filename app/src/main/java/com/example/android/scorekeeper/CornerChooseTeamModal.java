...
public class CornerChooseTeamModal extends DialogFragment {
    @Nullable
    @Override
    ...
    private class OnTeamAClickListener implements View.OnClickListener{
        ...
        public void onClick(View view) {
           // references MainActivity and gets addCornerTeamA method
           ((MainActivity)getActivity()).addCornerTeamA(view);
           dismiss();
        }
    }
    ...
    private class OnTeamBClickListener implements View.OnClickListener{
        @Override
        public void onClick(View view) {
            // references MainActivity and gets addCornerTeamB method
            ((MainActivity)getActivity()).addCornerTeamB(view);
            dismiss();
        }
    }
